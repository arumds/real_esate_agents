...
real_estate_agents/agent.py::_default_model), or set ADK_MODEL + GOOGLE_API_KEY to
use a native Gemini model instead.

Run:
    pip install "google-adk[extensions]"
    export OPENAI_API_KEY=sk-...
    python -m real_estate_agents.main
"""
...
from real_estate_agents.agent import DEFAULT_AUDIENCES, build_multi_audience_pipeline, build_pipeline
from real_estate_agents.callbacks import reset_call_log, summarize_call_log
